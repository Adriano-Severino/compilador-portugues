...
impl<'a> LlvmGenerator<'a> {
    ...
    fn native_async_operation(&self, name: &str) -> Option<(&'static str, ast::Tipo)> {
        match name {
    ...
    fn await_task_result(&mut self, task: &str, result_type: &ast::Tipo) -> (String, ast::Tipo) {
    ...
    fn find_async_function(&self, fqn: &str) -> Option<ast::DeclaracaoFuncao> {
